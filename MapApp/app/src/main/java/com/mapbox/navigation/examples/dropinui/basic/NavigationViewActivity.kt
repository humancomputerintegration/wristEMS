...
class NavigationViewActivity : AppCompatActivity(), PermissionsListener {
    ...
    private val distanceFromRoad = 70
    ...
    private val routeProgressObserver = RouteProgressObserver { routeProgress ->
        ...
        viewportDataSource.evaluate()
        if (routeProgress.currentLegProgress?.currentStepProgress?.distanceRemaining!! <=distanceFromRoad){
            if (!turning){
                Log.d("Start turning now","Start turning now")
                bluetooth.freqAdd("Start turning now")
                turning = true;
            }
        }else{
            if (turning){
                Log.d("Stop turning now","Stop turning now")
                bluetooth.freqAdd("Stop turning now")
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val rescan: Button = findViewById(R.id.rescan)
        rescan.setOnClickListener {
            bluetooth.setmBluetoothAdapter()
        }

        bluetooth.setBluetoothGattCallback("19b10000-e9f3-537e-4f6c-d104768a1214", "19b10001-e9f3-537e-4f6c-d104768a1214", "19b10002-e9f3-537e-4f6c-d104768a1214", "19b10003-e9f3-537e-4f6c-d104768a1214", "19b10004-e9f3-537e-4f6c-d104768a1214")
        val filter = IntentFilter(BluetoothDevice.ACTION_FOUND)
        registerReceiver(bluetooth.createReciever("E7:96:1E:84:FD:75"), filter)
